...
export const POST = async (req: Request) => {
    try {
        ...
        try {
            ...
            return Response.json("An error occured", { status: 400, headers: ACTIONS_CORS_HEADERS })
        }
        ...
        transaction.add(
            ...
            new TransactionInstruction({
                ...
                data: Buffer.from("This is a simple memo", "utf8"),
                keys: []
            })
        );
        ...
        // setting the post response that will be sent to user
        ...
        return Response.json("An error occured", { status: 400 })
    }
}   